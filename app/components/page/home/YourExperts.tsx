      ...
      >
        ...
        <div className="relative flex-1 px-4 md:px-12 py-14 flex flex-col justify-start ml:4 md:ml-8">
          ...
          <div className="relative z-10 max-w-md text-[14.5px] leading-[1.75]">
            ...
            {/* Bio paragraph 1 */}
            <p className="mb-4">
              Having worked as transformational coach with couples and groups
              the world over she is devoted to the restoration of conscious
              partnership and feminine–masculine harmony.
            </p>

            {/* Bio paragraph 2 */}
            <p className="mb-4">
              Her facilitation style is elegant, intuitive, and deeply attuned
              to the subtle emotional landscape of couples.
            </p>
            ...
            <p>
              ...
              intelligence to the{" "}
              <strong className="font-semibold">Sacred Union</strong>{" "}
              experience.
            </p>
          </div>
        </div>
